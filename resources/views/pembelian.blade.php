...
<div class="container"> @if(session('message')) <div class="alert alert-success m-3"> {{session('message')}}
    </div> @endif <table class="table table-secondary table-hover m-lg-2">
        <tr>
            ...
            <th>Status</th> @if(Auth::user()->role!='customer')
...
str_replace('/','',$p->kode_pembelian) }}">
    ...
    str_replace('/','',$p->kode_pembelian) }}">
            ...
            @if(Auth::user()->role!='customer')
            <td>
                <button class=" btn btn-danger" data-bs-toggle="modal" data-bs-target="#md{{ str_replace('/','',$p->kode_pembelian) }}">Delete </button>
            </td>
            @endif
        </tr>
        ...
        <div class="modal fade" id="md{{ str_replace('/','',$p->kode_pembelian) }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Delate pembelian</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
